...
public class PO_NavView extends PO_View {
    ...
    /**
     * Clic en una de las opciones principales (a href) y comprueba que se vaya a la vista con el elemento de tipo type
     * con el texto Destino
    ...
    public static void changeLanguage(WebDriver driver, String textLanguage) {
        ...
        List<WebElement> Selectedlanguage = SeleniumUtils.waitLoadElementsBy(driver, "id", textLanguage, getTimeout()); Selectedlanguage.get(0).click(); }
